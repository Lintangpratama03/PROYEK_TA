                ...
                <div class="col-xl-12">
                    <div class="card o-hidden">
                        <div class="card-header pb-0">
                            <div class="row">
                                <div class="col-xl-5">
                                    <h6>Detail Tunggakan Bedasarkan Level per NOP</h6>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-sm table-detail-tunggakan-level">
                                    <thead>
                                        <tr>
                                            <th>Tahun Pajak</th>
...
@section('js')
    ...
    <script>
        ...
        function table_detail_tunggakan_level() {
            let nop = "{{ $nop }}";
            var table = $(".table-detail-tunggakan-level").DataTable({
                ...
                buttons: [{
                    ...
                    "filename": 'Detail Tunggakan PBB Berdasarkan Level per NOP ',
                ...
                searchDelay: 2000,
                ajax: {
                    url: '{{ route('pbb.tunggakan.datatable_detail_tunggakan_level_nop') }}',
                    type: 'GET',
                    data: {
                        "nop": nop
                    }
