                ...
                <div class="card o-hidden">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-detail-tunggakan-kelurahan">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>NPWP</th>
...
@section('js')
    ...
    <script>
        ...
        function table_sub_tunggakan_kelurahan() {
            let kelurahan = "{{ $kelurahan }}";
            var table = $(".table-detail-tunggakan-kelurahan").DataTable({
                ...
                searchDelay: 2000,
                ajax: {
                    url: '{{ route('pbb.cluster.datatable_sub_tunggakan_wilayah') }}',
                    type: 'GET',
                    data: {
                        "kelurahan": kelurahan,
                    }
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var status = "{{ $kelurahan }}";
            document.querySelector('.card-header h6:nth-child(2)').textContent =
                "kelurahan Pajak Bumi dan Bangunan : " + status;
        });

        $(document).ready(function() {

            table_sub_tunggakan_kelurahan();
        })
    </script>
@endsection
