...
@section('title', 'Detail Tunggakan PDL - Smart Dashboard')
    ...
    function table_detail_tunggakan(){
       ...
       var table = $(".table-detail-tunggakan").DataTable({
            ...
            buttons: [{
                ...
                "titleAttr": 'Excel',
                "filename": 'Detail Tunggakan Pajak PDL',
	        ...
	        searchDelay: 2000,
            ajax: {
                url: '{{ route('pdl.tunggakan.datatable_detail') }}',
                type: 'GET',
                data: {
                  "tahun":tahun,
                  "pajak":pajak,
