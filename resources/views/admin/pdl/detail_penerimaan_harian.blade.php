...
@section('title', 'Detail Penerimaan Harian PDL - Smart Dashboard')
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Detail penerimaan Berdasarkan Penerimaan Harian PDL</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                </div>
                ...
                <div class="col-xl-12">
                    <div class="card o-hidden">
                        <div class="card-header pb-0">
                            <h6>Detail Penerimaan Berdasarkan Penerimaan Harian PDL </h6>
                            <h6></h6>
                        </div>
                        <div class="card-body">
...
@section('js')
    ...
    <script>
        ...
        function table_detail_penerimaan_harian() {
            ...
            var table = $(".table-detail-penerimaan-harian").DataTable({
                ...
                buttons: [{
                    ...
                    "titleAttr": 'Excel',
                    "filename": 'Detail Penerimaan Harian PDL',
                ...
                searchDelay: 2000,
                ajax: {
                    url: '{{ route('pdl.penerimaan.datatable_detail_penerimaan_harian') }}',
                    type: 'GET',
                    data: {
                        "tanggal": tanggal,
                        "kecamatan": kecamatan,
        ...
        document.addEventListener("DOMContentLoaded", function() {
            var status = "{{ $tanggal }}";
            document.querySelector('.card-header h6:nth-child(2)').textContent = "Tanggal Pajak : " + status;
        });
